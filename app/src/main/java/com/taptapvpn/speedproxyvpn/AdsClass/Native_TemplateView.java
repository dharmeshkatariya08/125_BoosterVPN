 ...
 */
public class Native_TemplateView extends FrameLayout {
    ...
    public Native_TemplateView(Context context) {
        super(context);
    }

    public Native_TemplateView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public Native_TemplateView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    public Native_TemplateView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.ads_native_medium_template_view) {
            return MEDIUM_TEMPLATE;
        } else if (templateType == R.layout.ads_native_small_template_view) {
        ...
        try {
            templateType =
                    attributes.getResourceId(
                            R.styleable.TemplateView_gnt_template_type, R.layout.ads_native_medium_template_view);
        } finally {
            attributes.recycle();
        }
